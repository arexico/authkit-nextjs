...
const WORKOS_REDIRECT_URI = process.env.NEXT_PUBLIC_WORKOS_REDIRECT_URI ?? getEnvVariable('WORKOS_REDIRECT_URI') ?? '';
const WORKOS_AUTHKIT_DOMAIN_OVERRIDE = process.env.NEXT_PUBLIC_WORKOS_AUTHKIT_DOMAIN_OVERRIDE;
...
export {
  ...
  WORKOS_REDIRECT_URI,
  WORKOS_AUTHKIT_DOMAIN_OVERRIDE,
};
